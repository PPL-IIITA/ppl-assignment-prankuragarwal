...
void print_ans::print(boys boy[], girls girl[], int coup_num, int gift_num, gifts gift[], vector<int> record[]){
...
int print_ans::calck(int coup_num){
	k = rand() % 10;
	k++;
	while (k > coup_num - 1){
		k = rand() % 10;
...
void print_ans::khappy(boys boy[], girls girl[], int coup_num, int k, double total[]){
...
void print_ans::kcompat(boys boy[], girls girl[], int coup_num, int k, int compatibility[]){
